          ...
          <div className="chest-section">
            ...
            <div className="chest-container">
              <div className="chest-3d">
                ...
                <div className={`chest-body ${isRevealing ? 'opening' : ''}`}>
                  <div className="chest-front"></div>
                  <div className="chest-back"></div>
                  <div className="chest-left"></div>
                  <div className="chest-right"></div>
                  <div className="chest-top"></div>
                  <div className="chest-bottom"></div>
                </div>
                
                <div className={`chest-lid ${isRevealing ? 'opening' : ''}`}>
                ...
                {isRevealing && (
                  <div className="chest-glow-effect"></div>
                )}
              </div>
